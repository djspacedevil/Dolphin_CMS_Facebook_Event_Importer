...
$fb_token = '?access_token?q=AAAHFZBjp3ZAZCcBAOMSWX6cHhfAd1AvZCpwlIcJKVTX8ZCqL4LJZB14XTDvJUlAUNhGVK0GhDMuYZCXUm7tIz0dBl6Nxr8gKrz0mMd26iyp5vuaZAjMVfZAs4';
...
// Token
        ...
        $new_token = curl_exec($ch);
    		...
    		//preg_match_all('/access_token=(.*)&expires_in/iU', $new_token, $token);
